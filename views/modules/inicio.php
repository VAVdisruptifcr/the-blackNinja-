...
<div id="inicio">
	...
	<div id="nivel1" class="niveles">
		...
		<img src="views/img/intro/checkLevel1.svg" alt="">
...
<!-- 				<li>
					<img src="views/img/intro/juan.png" alt="">
					<h3>Juan</h3>
					<h3>100 pts</h3>
				</li>
				<li>
	...
	<div id="nivel2" class="niveles">
		...
		if($_SESSION["nivel2"] == "ok"){
			...
			echo '<img src="views/img/intro/checkLevel1.svg">
...
<div id="btnAmpliar" onclick="ampliar()">Ampliar</div>
